...
app.get("/api/json/:jsonName", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
app.get("/api/port/:port", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var port, ip, scan, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                port = parseInt(req.params.port);
                ip = (req.headers['x-forwarded-for'] || req.connection.remoteAddress || '').split(',')[0].trim();
                scan = portscanner_1.default.checkPortStatus(port, ip);
                return [4 /*yield*/, scan];
            case 1:
                result = _a.sent();
